...
final class Lucene84OrdsIntersectTermsEnumFrame {
    final int ord;
    long fp;
    long fpOrig;
    long fpEnd;
    ...
    private final Lucene84OrdsIntersectTermsEnum ite;

    public Lucene84OrdsIntersectTermsEnumFrame(Lucene84OrdsIntersectTermsEnum ite, int ord) throws IOException {
        this.ite = ite;
        this.ord = ord;
