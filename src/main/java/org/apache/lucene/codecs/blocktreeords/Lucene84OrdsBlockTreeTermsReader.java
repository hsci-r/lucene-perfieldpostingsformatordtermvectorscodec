...
public final class Lucene84OrdsBlockTreeTermsReader extends FieldsProducer {
  ...
  private final TreeMap<String,Lucene84OrdsFieldReader> fields = new TreeMap<>();

  /** Sole constructor. */
  public Lucene84OrdsBlockTreeTermsReader(PostingsReaderBase postingsReader, SegmentReadState state) throws IOException {
    ...
    try {
      ...
      for(int i=0;i<numFields;i++) {
        ...
        Lucene84OrdsFieldReader previous = fields.put(fieldInfo.name,
                                              new Lucene84OrdsFieldReader(this, fieldInfo, numTerms, rootCode, sumTotalTermFreq, sumDocFreq, docCount,
  ...
  public long ramBytesUsed() {
    ...
    for (Lucene84OrdsFieldReader reader : fields.values()) {
