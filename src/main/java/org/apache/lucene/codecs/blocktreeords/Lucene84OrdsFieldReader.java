...
final class Lucene84OrdsFieldReader extends Terms implements Accountable {
    final long numTerms;
    ...
    final Lucene84OrdsBlockTreeTermsReader parent;

    final FST<Output> index;
    //private boolean DEBUG;

    Lucene84OrdsFieldReader(Lucene84OrdsBlockTreeTermsReader parent, FieldInfo fieldInfo, long numTerms,
    ...
    public TermsEnum iterator() throws IOException {
        return new Lucene84OrdsSegmentTermsEnum(this);
    }
    ...
    public TermsEnum intersect(CompiledAutomaton compiled, BytesRef startTerm) throws IOException {
        ...
        return new Lucene84OrdsIntersectTermsEnum(this, compiled, startTerm);
    }
