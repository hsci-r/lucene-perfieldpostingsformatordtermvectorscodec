...
final class Lucene84OrdsSegmentTermsEnumFrame {
    // Our index in stack[]:
    final int ord;
    ...
    // static boolean DEBUG = Lucene84OrdsSegmentTermsEnum.DEBUG;
    ...
    private final Lucene84OrdsSegmentTermsEnum ste;

    public Lucene84OrdsSegmentTermsEnumFrame(Lucene84OrdsSegmentTermsEnum ste, int ord) throws IOException {
        this.ste = ste;
        this.ord = ord;
    ...
    */
    ...
    public SeekStatus scanToTermLeaf(BytesRef target, boolean exactOnly) throws IOException {
        ...
        // if (DEBUG) System.out.println("    scanToTermLeaf: block fp=" + fp + " prefix=" + prefix + " nextEnt=" + nextEnt + " (of " + entCount + ") target=" + Lucene84OrdsSegmentTermsEnum.brToString(target) + " term=" + Lucene84OrdsSegmentTermsEnum.brToString(ste.term));
        ...
        nextTerm: while (true) {
            ...
            //    System.out.println("      cycle: term " + (nextEnt-1) + " (of " + entCount + ") suffix=" + Lucene84OrdsSegmentTermsEnum.brToString(suffixBytesRef));
            // }
    ...
    public SeekStatus scanToTermNonLeaf(BytesRef target, boolean exactOnly) throws IOException {
        ...
        // if (DEBUG) System.out.println("    scanToTermNonLeaf: block fp=" + fp + " prefix=" + prefix + " nextEnt=" + nextEnt + " (of " + entCount + ") target=" + Lucene84OrdsSegmentTermsEnum.brToString(target) + " term=" + Lucene84OrdsSegmentTermsEnum.brToString(ste.term));
